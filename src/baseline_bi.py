...
#%%
data_train = pd.read_csv('/content/drive/MyDrive/baseline/bert_train.csv', index_col=0)
data_test = pd.read_csv('/content/drive/MyDrive/baseline/bert_test.csv', index_col=0)
data_val = pd.read_csv('/content/drive/MyDrive/baseline/bert_valid.csv', index_col=0)
...
data_val = data_val.rename(columns={'predict':'fullText', 'gold': 'summary'})
#%%
...
# encoder_outputs, state_h_f, state_c_f, state_h_b, state_c_b = encoder_output1, state_h1_f, state_c1_f, state_h1_b, state_c1_b
...
model.save(r'/content/drive/MyDrive/baseline/model.h5')

# model = tf.keras.models.load_model(r'/content/drive/MyDrive/baseline/model.h5')
...
encoder_model = Model(inputs=encoder_inputs,outputs=[encoder_outputs, state_h_f, state_c_f, state_h_b, state_c_b])
...
result.to_csv('/content/drive/MyDrive/baseline/predict_baseline.csv')
